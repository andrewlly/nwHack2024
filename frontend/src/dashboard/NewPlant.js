  ...
  return (
    <>
        ...
        <div style={{display: 'flex', flexDirection: 'row'}}>
          <div style={{backgroundColor: 'white', width: '140px', height: '210px', marginRight: '20px', border: '2px solid #0a3c57', borderRadius: '20px'}}>
          ...
          <label className="newLabels" htmlFor="plantName">Plant Name:</label>
            ...
            <select
              style={{ marginBottom: '20px', padding: '10px', height: '40px', color: 'gray' }}
              id="plantType"
              value={selectedPlant}
            ...
            <button style={{ width: '100%' }} className="submit" >Add Plant</button>
