...
/**
* @author liuyu
* @description 针对表【plant_stages】的数据库操作Service实现
* @createDate 2024-01-20 16:53:09
*/
@Service
public class PlantStagesServiceImpl extends ServiceImpl<PlantStagesMapper, PlantStages>
    implements PlantStagesService{
